...
var nicEditorIFrameInstance = nicEditorInstance.extend({
	...
	initFrame : function() {
          /* Mod for being compatible with the4 free hosting*/
	},
...
// --------
  ...
  var textEditor=new nicEditor({iconsPath : 'images/nicEditorIcons.gif'}).panelInstance('areaedition');
  textEditor.nicInstances[0].elm.innerHTML=textEditorSaved;
  var saveData=function(){
    textEditorSaved=textEditor.nicInstances[0].elm.innerHTML;
  };
