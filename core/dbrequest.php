...
switch ($parameters->action) {
  ...
  case "load my children": $myexecfunction="db_loadmychildren"; if (isset($parameters->filter)) $argument=$parameters->filter; break;
  case "load my parent": $myexecfunction="db_loadmyparent"; break;
  case "load my partner": $myexecfunction="db_loadmypartner"; break;
  ...
  case "load my tree up": $myexecfunction="db_loadmytreeup"; if (isset($myelement->extra->level)) $argument=$myelement->extra->level; break;
...
//if ($myexecfunction=="db_loadmytreeup") var_dump($myelement);
