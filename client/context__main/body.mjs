...
export async function bodyView(){
  ...
  setPageTitle(getSiteContent().getNextChild("page_head_title"), selectorFromAttr(body, "data-title")) // Set the head title field and the browser page title
  ...
  getSiteContent().getNextChild("page_head_subtitle").setContentView(selectorFromAttr(body, "data-subtitle"), false)
