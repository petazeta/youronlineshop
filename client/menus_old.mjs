export function docView(menuNode, pushHistoryState){
  menuNode.setView(document.getElementById("centralcontent"), "doc");
  pushHistoryState('?menu=' + menuNode.props.id);
}

export function setMenus(getTextRoot, webuser, getActiveInGroup, createInstanceChildText){
  const menusMother=getTextRoot().getMainBranch();
