...
export async function prueba(){
  console.log("si", themesTreeMum);
  return await themesTreeMum.loadRequest("get themes tree");
}
...
export async function startTheme(id){
  ...
  if (!themesTreeMum.getChild()) await loadThemesTree();
...
function loadThemesTree(){
  return themesTreeMum.loadRequest("get themes tree");
}
