<template>
  <template id="extraedittp">
	...
	<script>
	  ...
	  myNode.appendThis(thisElement,"includes/templates/singlefield.php");
	</script>
      </div>
    </template>
    <div>
	...
	<script>
      ...
      <script>
	(new Node()).appendThis(thisElement,"includes/templates/loginform.php");
      </script>
      <div data-id="containernew"></div>
      <script>
	(new Node()).appendThis(thisElement,"includes/templates/newform.php");
      </script>
    </div>
  </template>
