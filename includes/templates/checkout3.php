<template>
  <template>
    ...
    <script>
      ...
      (new Node()).refreshView(thisElement, "includes/templates/shippinglist.php");
    </script>
	...
	thisElement.onclick=function(){
	  ...
	  //We have added the ordershippingtype to the order
	    (new Node()).refreshView(document.getElementById("centralcontent"),"includes/templates/checkout4.php");
	  });
	  return false;
	};
      </script>
