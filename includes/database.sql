...
--
-- Host: localhost
-- Generation Time: Apr 27, 2018 at 07:49 PM
...
(32, 'license', 'Creative Commons License'),
(33, 'designed', 'alberto melchor'),
...
(46, '', '<div>There are three olready created users: "user1", "user2" and "user3". These are the users names, and users passwords are the same as users names. User "user2" is order administrator and can watch and edit all the orders. Once you log in with this user click at Show orders button. User "user3" is web administrator user and can edit the web page content like the catalog (categories and items).<br></div>'),
...
(48, '', 'Continue at How to'),
(49, '', 'To start: log in with one of the users or sign in with a new one.'),
(50, '', 'More information at: <a href="https://github.com/petazeta/youronlineshop/wiki">Project Docs</a>'),
(52, '', '<b>Tip:</b> There is also available for purchase a tool named dbmanager. This tool is very useful to edit the database records. Get more information at: <a href="http://youronlineshop.sourceforge.net/dbmanager">Dbmanager Home</a>');
...
--
-- Table structure for table `websections`
--
...
--
-- Dumping data for table `websections`
--
...
--
-- AUTO_INCREMENT for table `websections`
--
ALTER TABLE `websections`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=11;
